    ...
    <div class="flex">
        ...
        <main class="flex-1 p-6 lg:p-8">
            <div class="mb-8">
                ...
                <p class="text-gray-600">Find career opportunities posted by alumni</p>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-12 text-center">
                ...
                <p class="text-sm text-gray-500">In the meantime, check out our <a href="services.php" class="text-primary hover:underline">services marketplace</a> for job posting services.</p>
            </div>
        </main>
    </div>
</body>
