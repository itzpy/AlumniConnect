...
<head>
    ...
    <title>My Network - Alumni Connect</title>
...
<body class="bg-gray-50">
    ...
    <div class="flex">
        ...
        <main class="flex-1 p-6 lg:p-8">
            <div class="mb-8">
                <h1 class="text-3xl font-bold text-gray-900 mb-2">My Network</h1>
                <p class="text-gray-600">Manage your connections and grow your network</p>
            </div>
